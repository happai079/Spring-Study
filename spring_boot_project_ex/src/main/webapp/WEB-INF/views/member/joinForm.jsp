		        ...
		        <form id="joinForm" name="joinForm" method="post"  action="/join">
	        		<table>
		            	...
		            	<tr>
		            		<th>학년</th>
		            		<td>
		            			<input type="radio" id="memYear1" name="memYear" value="1" >1학년
                                <input type="radio" id="memYear2" name="memYear" value="2">2학년
                                <input type="radio" id="memYear3" name="memYear" value="3">3학년
                                <input type="radio" id="memYear4" name="memYear" value="4">4학년
                            </td>
                        </tr>
		            	<tr>
		            		<th>관심분야</th>
		                  	<td>
		                  		<input type="checkbox"  id="web" name="memInterests" value="웹프로그래밍">웹 프로그래밍
		                        ...
		                        <input type="checkbox"  id="java" name="memInterests" value="자바프로그래밍">자바 프로그래밍
	                        </td>
                        </tr>
		            	<tr>
		            		<th>학과</th>
		                  	<td>
		                  		<select id="memDepartment" name="memDepartment">
