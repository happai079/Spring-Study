...
<html>
	...
	<body>
		...
		<form method="post" action="/mybatis/product/insertProduct">
			<table>
				<tr><td>상품 번호</td><td><input type="text" id="prdNo" name="prdNo"><input type="button" id="prdNoCheckBtn" value="중복 확인"></td></tr>
				...
				<tr><td colspan="3"><input type="submit" value="등록"><input type="reset" value="취소"></td></tr>
			</table>
		</form>
	</body>
</html>